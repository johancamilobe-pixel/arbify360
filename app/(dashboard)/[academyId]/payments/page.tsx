    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div className="bg-card rounded-xl border border-border p-4">
          <p className="text-xs text-muted-foreground font-medium">Pendiente por pagar</p>
          <p className="text-xl font-bold text-orange-600 mt-1">{fmt(totalPending)}</p>
          <p className="text-xs text-muted-foreground mt-0.5">
            {pendingGroups.length} arbitro{pendingGroups.length !== 1 ? "s" : ""}
          </p>
        </div>
        <div className="bg-card rounded-xl border border-border p-4">
          <p className="text-xs text-muted-foreground font-medium">Pagado este periodo</p>
          <p className="text-xl font-bold text-red-600 mt-1">{fmt(totalPaid)}</p>
          <p className="text-xs text-muted-foreground mt-0.5">
            {completedCount} pago{completedCount !== 1 ? "s" : ""}
          </p>
        </div>
        <div className="bg-card rounded-xl border border-border p-4">
          <p className="text-xs text-muted-foreground font-medium">Ingresos recibidos</p>
